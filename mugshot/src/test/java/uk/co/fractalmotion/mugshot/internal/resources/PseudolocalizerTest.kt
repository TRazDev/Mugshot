...
/**
 * Ported from: [PseudolocalizerTest.kt](https://cs.android.com/android-studio/platform/tools/base/+/cbf409d1cccb87e8b23798638a8fbf0362af070d:build-system/aaptcompiler/src/test/java/com/android/aaptcompiler/PseudolocalizerTest.kt)
 */

internal val bidiWordStart = String(
  byteArrayOf(
    0xe2.toByte(),
    0x80.toByte(),
    0x8f.toByte(),
...
internal val bidiWordEnd = String(
  byteArrayOf(
    0xe2.toByte(),
    0x80.toByte(),
    0xac.toByte(),
...
class PseudolocalizerTest() {
  ...
  fun testNestedICU() {
    simpleTest(
      "{person, select, female {{num_circles, plural,=0{{person} didn't add you " +
