...
```groovy
dependencies {
  lintChecks 'uk.co.fractalmotion.mugshot:mugshot-preview-lints:3.4.1'
}
```
...
buildscript {
  ...
  dependencies {
    classpath 'uk.co.fractalmotion.mugshot:mugshot-gradle-plugin:3.4.1'
  }
}
...
```groovy
plugins {
  id 'uk.co.fractalmotion.mugshot' version '3.4.1'
}
```
